            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    IconButton(onPressed: (){ Get.back(); homeCtrl.editCtrl.clear();homeCtrl.changeTask(null);}, icon: const Icon(Icons.close)),
              ...
              Padding(
                ...
                child: Text(
                  'Add to',style: TextStyle(fontSize: 14.0.sp, color: Colors.grey),
                ),
              ),
