...
import 'package:getx_todo_list/app/modules/home/json.dart';
                ...
                children: [
                  ...
                  Obx(()=>
                     GridView.count(
                      ...
                      children: [
                        // TaskCard(
                        //   task: Task(title: 'title', icon: 0xe59c, color: '#FF2B60E6', todos: []),
                        // ),
        ...
        builder: (_,__,___){
            return  Obx(()=>
                FloatingActionButton(
                  backgroundColor: controller.deleting.value ? Colors.red: Colors.lightBlue,
                  onPressed: (){
